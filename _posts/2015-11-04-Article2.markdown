...
<strong>Lorsque l’on met un site web en ligne ou que l’on crée de nouvelles pages sur un site existant, il est important de se faire référencer afin d’être visibles de internautes via les résultats des moteurs de recherche. 

Or ces derniers, comme Google & Bing, utilisent des robots indexeurs, logiciels qui parcours pages et sites internet afin de les analyser et de juger de leur pertinence. Mais comment ce processus d’indexation se déroule-t-il?</strong>
