...
categories: SEO
tags: SEO, mobile-friendly, responsive
...
<figure align="center">
  <img src="http://image.noelshack.com/fichiers/2016/06/1455045926-article3-image1.png" alt="Exemple de test mobile-friendly pour notre    blog seo-positif.fr - 1" width="100%"/>
  <figcaption>Fig. 1 - Exemple de test mobile-friendly pour notre blog seo-positif.fr</figcaption>
</figure>

<figure align="center">
  <img src="http://image.noelshack.com/fichiers/2016/06/1455045926-article3-image2.png" alt="Exemple de test mobile-friendly pour notre    blog seo-positif.fr - 2" style="height: 400px;"/>
...
## Cas d'étude : les maisons à ossature bois
Afin de tester notre hypothèse, nous avons dans un premier temps effectué une recherche (en navigation privée) sur ordinateur puis sur mobile autour des mots clés "maison ossature bois" dont voici les résultats :

<figure align="center">
  <img src="http://image.noelshack.com/fichiers/2016/06/1455051700-resultats-google-laptop.png" alt="Résultats Google - Recherche laptop" width="100%"/>
  <figcaption>Fig. 4 - Résultats Google : Recherche laptop</figcaption>
</figure>

<figure align="center">
  <img src="http://image.noelshack.com/fichiers/2016/06/1455051935-resultats-google-mobile.png" alt="Résultats Google - Recherche mobile" width="100%"/>
  <figcaption>Fig. 5 - Résultats Google : Recherche mobile</figcaption>
</figure>

On observe bien des résultats nettement différents sur les deux terminaux avec la présence de tendancebois.fr en première position pour la recherche laptop contre bois.com pour la recherche mobile.

Nous avons donc comparé l'optimisation mobile de ces deux pages grâce à l'outil varvy.com/mobile/ développé par Patrick Sexton. Les résultats obtenus nous indiquent bien que le site favorisé par Google sur mobile est plus mobile-friendly que celui qui apparait en premier pour la recherche sur ordinateur :

<figure align="center">
  <img src="http://image.noelshack.com/fichiers/2016/06/1455051700-test1-1.png" alt="Test mobile-friendly - tendancebois.fr" width="100%"/>
  <figcaption>Fig. 5 - Test mobile-friendly : tendancebois.fr</figcaption>
</figure>

<figure align="center">
  <img src="http://image.noelshack.com/fichiers/2016/06/1455051701-test2-1.png" alt="Test mobile-friendly - bois.com" width="100%"/>
  <figcaption>Fig. 6 - Test mobile-friendly : bois.com</figcaption>
</figure>

Nous avons réitéré cette expérience avec de nombreux mots clés, notamment pour la vente de meubles et d'appareils photos numériques et chaque fois les résultats corroboraient notre hypothèse de départ mais dans une moindre mesure. Le test s'avère donc être concluant.

## Le Responsive Design : enjeu d'avenir
...
Enfin, comme évoqué précédemment, l'optimisation de l'affichage des pages web au support utilisé ne concerne bien évidemment pas que le mobile et les tablettes comme c'est - plus ou moins - le cas de nos jours. En effet, l'apparition de nouveaux canaux de navigation web et de nouveaux objets connectés en tous genres vont probablement amener les moteurs de recherche à également favoriser le contenu le plus adapté à chaque appareil. 

C'est pourquoi il serait intéressant d'étudier les enjeux de l'apparition de ces nouveaux appareils et leurs impacts sur le référencement naturel dans les années à venir. Si Google, notamment, continue dans cette démarche, le responsive design va encore beaucoup évoluer et être au centre des futures problématiques de référencement.

<figure align="center">
  <img src="http://dootrix.com/wp-content/uploads/2014/04/wearables.jpg" alt="Wearables" width="100%"/>
  <figcaption>Fig. 7 - Wearables et autres objets connectés : quels enjeux pour le e-marketing de demain ?</figcaption>
</figure>

En outre, ces nouvelles tendances de consommation digitale, avec entre autres l'expansion du marché des wearables, participent au développement de la tendance du marketing hyperlocal. Un autre sujet d'analyse pertinent autour de ces problématiques serait donc d'évaluer les évolutions du marketing digital causées par ces nouveaux appareils.
